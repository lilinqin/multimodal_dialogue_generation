...
from src.mm_data_set import *
from src.mm_models_attention import MMBartForConditionalGeneration
...
name2bertpath = {
    "MMBartForConditionalGeneration": '/home/lqli/video_dialog_generation/pretrain/bart-base',
}
...
def get_args():
    ...
    parser.add_argument('--frame', default="friendsVideoSegFeature", type=str, help='frame')
    parser.add_argument('--nogate', action='store_true', default=False)
...
def main():
    ...
    logging.info('finish')
    os.remove(f'{save_dir}model_{args.seed}_{args.lr}.bin')
